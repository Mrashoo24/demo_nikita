...
class HRservies extends StatefulWidget {
  const HRservies({Key? key}) : super(key: key);

  @override
  _HRserviesState createState() => _HRserviesState();
}

class _HRserviesState extends State<HRservies> {
  @override
