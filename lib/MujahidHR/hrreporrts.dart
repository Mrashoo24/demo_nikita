...
class HRReport extends StatefulWidget {
  ...
  const HRReport({Key? key, required this.userModel}) : super(key: key);
        ...
        body: FutureBuilder<List<UserModel>?>(
            ...
            builder: (context, snapshot) {
              ...
              var dropDownEmployee = employyeList.map((e) {
                if (e.hrId != null && e.hrId == widget.userModel.empId) {
                  return e.name;
                }
              }).toList();
                                ...
                                icon: Align(
                                    ...
                                    child:  Row(
                                      ...
                                      children: [
                                        Container(
                                            width: Get.width*0.8,
                                            child: Text(selectedValue == null ? " Select" : selectedValue!,style:TextStyle(fontSize: 17,fontWeight: FontWeight.bold) ,overflow: TextOverflow.ellipsis,)),
